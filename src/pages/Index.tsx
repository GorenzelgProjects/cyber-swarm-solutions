  ...
  const features = [
    {
      ...
      description:
        "Specialised AI agents collaborate in real-time, simulating red-team attacks and blue-team defence in safe, bounded environments.",
    },
    {
      icon: Shield,
      title: "Proactive Defence",
      description:
        "Discover vulnerabilities internally before attackers do through continuous, realistic threat simulation.",
    },
    {
      icon: Eye,
      title: "Explainable & Auditable",
      description:
        "Every agent decision is traceable and transparent, meeting NIS2 compliance requirements with full visibility.",
    },
    {
      icon: Target,
    ...
    },
    {
      ...
      description:
        "Agents evolve from analyst decisions and simulation outcomes, improving detection capabilities over time.",
    },
    {
      icon: Lock,
  ...
  return (
    <div className="min-h-screen" style={{ margin: 0 }}>
      ...
      >
        ...
        <div className="relative z-10 max-w-[820px] mx-auto text-center" style={{ marginTop: 0 }}>
          <div className="animate-fade-in" style={{ marginTop: 0 }}>
            ...
            >
              Proactive, Explainable <span className="text-primary">Cyber Defence</span>
            </h1>
            <p
            ...
            >
              Europe's first multi-agent AI platform that simulates real attacker behaviour to uncover vulnerabilities
              internally, then translates findings into auditable actions your SOC can trust.
            </p>
      ...
      <section className="py-24 px-4">
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center space-y-6 mb-16 animate-fade-in">
            <h2 className="text-4xl md:text-5xl font-bold text-foreground">The Cybersecurity Challenge</h2>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Organisations face unprecedented threats whilst struggling with talent shortages and increasingly complex
              compliance mandates.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="bg-card border-border shadow-card hover:shadow-hover transition-all duration-300 animate-fade-in rounded-2xl">
              <CardContent className="p-8 space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Generative AI lowers barriers for attackers. NIS2 requires ~3,000 Danish organisations to demonstrate
                  explainable, auditable security measures.
                </p>
              </CardContent>
            </Card>
            ...
            >
              <CardContent className="p-8 space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Waiting for incidents is costly. NotPetya cost Mærsk ≈ DKK 2 billion. Proactive simulation finds
            ...
            >
              <CardContent className="p-8 space-y-4">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ~4.7 million unfilled cybersecurity roles globally. Organisations need intelligent automation for 24/7
                  coverage and expert-level analysis.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-24 px-4 bg-muted/30">
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center space-y-6 mb-16 animate-fade-in">
            <h2 className="text-4xl md:text-5xl font-bold text-foreground">Our Innovative Approach</h2>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Multi-agent systems working together to provide proactive, traceable, and continuously improving
              cybersecurity.
            </p>
          </div>
        ...
        <div className="container mx-auto">
          <Card className="bg-gradient-mesh border-border shadow-hover overflow-hidden rounded-2xl max-w-4xl mx-auto">
            <CardContent className="p-12 md:p-16 text-center space-y-8">
              <h2 className="text-3xl md:text-4xl font-bold text-foreground">Ready to Stay Ahead of Cyber Threats?</h2>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Join the organisations transforming their cybersecurity from reactive to proactive with ColleaiQ's
                explainable multi-agent AI platform.
              </p>
